      ...
      {!loading && (
        <div className="px-3 py-4 space-y-4">
          <div className="bg-gradient-to-br from-sky-500 to-indigo-600 rounded-2xl p-4 text-white">
            <div className="text-[16px] font-bold">Invite your customers to DueBook</div>
            <div className="text-[13px] opacity-90 mt-1">
              Grow your social feed — share this link and let them join.
            </div>
          </div>

          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-800 p-3">
            <div className="text-[11px] uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-1">Your invite link</div>
            <div className="flex items-center gap-2">
              <input readOnly value={inviteUrl}
                className="flex-1 bg-gray-100 dark:bg-slate-800 rounded-lg px-3 py-2 text-[12.5px] outline-none" />
              <button onClick={copyLink}
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-sky-500 text-white">
                <Copy size={14} />
              </button>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-800 p-3">
            <div className="text-[13px] font-semibold mb-2">Send invitation on WhatsApp</div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-800 p-3">
            <div className="text-[13px] font-semibold mb-2">Share options</div>
