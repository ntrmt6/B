...
export const DEMO_WEBSITE_CONFIG: Partial<WebsiteConfig> = {
  ...
  headerLogo: 'https://res.cloudinary.com/douutkuah/image/upload/v1778851990/snitlogo_lfcy5c.png',
...
export function isMainDomain(): boolean {
  ...
  const primaryDomain = process.env.NEXT_PUBLIC_PRIMARY_DOMAIN || 'allinbangla.com';
