...
import { getStoreUrl, getHostTenantSlug } from '../utils/appHelpers';
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 lg:p-8 space-y-4 sm:space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        ...
        {(() => {
          const resolvedSubdomain = tenantSubdomain || websiteConfig?.domain || (typeof window !== 'undefined' ? getHostTenantSlug() || (window as any).__CUSTOM_DOMAIN_TENANT__?.subdomain : '') || '';
          return (
            <button
              onClick={() => window.open(getStoreUrl(resolvedSubdomain || websiteConfig?.domain || 'store'), '_blank')}
