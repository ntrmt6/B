...
/**
 * Get Authorization header for upload requests.
 * Does NOT include Content-Type so FormData boundary is set automatically by the browser.
 */
...
/**
 * Get Authorization + JSON Content-Type headers for non-upload requests (e.g. gallery save, delete).
 */
